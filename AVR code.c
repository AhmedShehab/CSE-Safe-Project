...
int main(void)
{
	...
	DDRD=0x0f;
	/*PORTD's upper 4 bits are declared input and lower 4 bits are declared output(4x4 Keypad is connected)*/

	PORTD=0xff;
	/*PORTD's lower 4 bits are given high value and pull-up are enabled for upper 4 bits*/
